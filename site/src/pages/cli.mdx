...
This command will lint the `taplo.toml` file with a [built-in schema](/configuration/#official-schemas) and report errors.
...
<pre class="cli-output">
  ...
  : <b>processed 1 document with 1 error </b>
</pre>
